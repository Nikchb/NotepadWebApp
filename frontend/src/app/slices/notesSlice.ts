...
export const { setNotes, addNote, updateNote, deleteNote, removeNotes } =
  notesSlice.actions;
...
export const fetchNotesAsync =
  ...
  async (dispatch): Promise<boolean> => {
    try {
      const response = (await axios.get("/notes")) as AxiosResponse<
        ServiceResponse<NoteListItemDTO[]>
      >;
...
export const fetchNoteAsync =
  (id: string): AppThunk<Promise<NoteDTO | undefined>> =>
  async (): Promise<NoteDTO | undefined> => {
    try {
      const response = (await axios.get(`/notes/${id}`)) as AxiosResponse<
        ServiceResponse<NoteDTO>
      >;
      if (response.data.success && response.data.data) {
...
export const createNoteAsync =
  ...
  async (dispatch): Promise<boolean> => {
    try {
      const response = (await axios.post("/notes", model)) as AxiosResponse<
        ServiceResponse<NoteDTO>
      >;
      if (response.data.success && response.data.data) {
...
export const updateNoteAsync =
  ...
  async (dispatch): Promise<boolean> => {
    try {
      const response = (await axios.put("/notes", model)) as AxiosResponse<
...
export const deleteNoteAsync =
  ...
  async (dispatch): Promise<boolean> => {
    try {
      const response = (await axios.delete(`/notes/${id}`)) as AxiosResponse<
        ServiceResponse<undefined>
      >;
      if (response.data.success) {
